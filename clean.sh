...
cd ../gland/
find /home/shailesh/Niramai/Niramai_cases/with_subprocess/gland/constant -maxdepth 1 -mindepth 1 -not -name cellToRegion -not -name regionProperties -not -name toleranceDict -not -name triSurface -not -name gland -not -name muscle -not -name tissue -exec rm -R {} \;
